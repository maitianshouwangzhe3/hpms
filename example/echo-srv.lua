...
hpms.add_timer(400, function ()
    print("hello world 400", hpms.time())
end)
local ele = hpms.add_timer(600, function ()
    print("hello world 600", hpms.time())
end)
hpms.add_timer(700, function ()
    print("hello world 700", hpms.time())
end)
hpms.add_timer(800, function ()
    print("hello world 800", hpms.time())
end)
hpms.del_timer(ele)
hpms.add_timer(900, function ()
    print("hello world 900", hpms.time())
end)
